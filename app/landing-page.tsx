...
export function LandingPage() {
  ...
  return <main>
    ...
    <footer><a className="wordmark" href="#top">DON <i>RAMITH</i></a><p>CONFIDENCE · AUTHENTICITY · CONNECTION</p><div role="navigation" aria-label="Social links"><a href="https://www.instagram.com/donramith/" target="_blank" rel="noreferrer">Instagram</a><a href="https://youtube.com/@donramith?sub_confirmation=1" target="_blank" rel="noreferrer">YouTube</a><span>© 2026</span></div></footer>
